-- CreateEnum
CREATE TYPE "public"."AuthProvider" AS ENUM ('CREDENTIALS', 'GOOGLE', 'GITHUB', 'MICROSOFT');

-- AlterTable
ALTER TABLE "public"."User" ADD COLUMN     "authProvider" "public"."AuthProvider" NOT NULL DEFAULT 'CREDENTIALS',
